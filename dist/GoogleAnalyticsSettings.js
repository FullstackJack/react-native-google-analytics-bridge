...
class GoogleAnalyticsSettings {
    ...
    static setOptOut(enabled) {
        NativeBridges_1.AnalyticsSettings.setOptOut(enabled);
    }
    /**
    ...
    static setDispatchInterval(intervalInSeconds) {
        NativeBridges_1.AnalyticsSettings.setDispatchInterval(intervalInSeconds);
    }
    /**
    ...
    static setDryRun(enabled) {
        NativeBridges_1.AnalyticsSettings.setDryRun(enabled);
    }
}
exports.default = GoogleAnalyticsSettings;
